// This is a simple test script to verify our AI date parser
// Run with: node scripts/test-date-parser.js

const { parseDateTime, formatDateForHumans } = require('../lib/ai-date-parser');
